...
All commands run from the project root (`D:/Project/MyWiki` or wherever this project lives):
...
This auto-deploys to wiki.iliudar.com and wiki.aibc.cafe via Vercel.
